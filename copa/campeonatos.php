...
<body onload="init();">
  ...
  <!-- Centered Tabs -->
  <div class="submenu" style="margin-top: -35px; height: 44px;">
        ...
        <div class="row">
          <div class="col-sm-4 col-md-3 col-lg-2">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              <a class="dropdown-item" href="#" data-toggle="modal" data-target="#exampleModal">Detalle del campeonato</a>
              <a class="dropdown-item" href="#" data-toggle="modal" data-target="#equipos">Editar equipos</a>
              <a class="dropdown-item" href="#" data-toggle="modal" data-target="#inscripciones">Editar inscripciones</a>
              <a class="dropdown-item" href="#" data-toggle="modal" data-target="#fases">Editar Fases</a>
              <a class="dropdown-item" href="#" data-toggle="modal" data-target="#grupos">Editar Grupos</a>
              <a class="dropdown-item" href="#" data-toggle="modal" data-target="#opciones">Editar Opciones del deporte</a>
              <a class="dropdown-item" href="#" data-toggle="modal" data-target="#arbitraje">Arbitraje y Lugares</a>
              <a class="dropdown-item" href="#" data-toggle="modal" data-target="#encuesta">Ranking y Encuestas</a>
              <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modeladores">Modeladores y visualizaciones</a>
              <a class="dropdown-item" href="#" data-toggle="modal" data-target="#auspiciadores">Editar patrocinios</a>
              <a class="dropdown-item" href="#" data-toggle="modal" data-target="#planes">Planes de suscripción</a>
          ...
          <div class="col-sm-8 col-md-9 col-lg-9">
            <ul class="nav nav-tabs nav-justified" style="padding: 10px; border: none;">
              <li class="active"><a href="#" style="padding: 10px; color: white;">INICIO</a></li>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <button type="button" class="close" data-dismiss="modal" data-toggle="modal" data-target="#exampleModal5" aria-label="Close">
          ...
          <div class="input-group">
            ...
            <div class="input-group-append"><button class="btn btn-outline-secondary small" type="button">AGREGAR</button></div>
          </div>
            ...
            <div class="list list-equipment">
              <ul>
                <li class="ng-star-inserted line-bottom">
                  ...
                  <h4>aass</h4>
                  <p>
                    <span class="ng-star-inserted">Grupo: B </span>
                    <span class="ng-star-inserted"> - </span>
                    <span class="ng-star-inserted">8 Jugadores </span>
                  </p>
                </li>
                <li class="ng-star-inserted line-bottom">
                  <img src="assets/images/logo2.png">
                  ...
                  <p>
                    <!---->
                    <span class="ng-star-inserted">Grupo: A </span>
                  </p>
                </li>
              </ul>
            </div>
          ...
          <div class="modal-body">
            ...
            <div class="modal-body">
              <ul class="list-group">
                ...
                <li class="list-group-item list-group-item-action mousePoi" data-toggle="modal" data-target="#editfase"></li>
              </ul>
            </div>
          </div>
    ...
    <div class="row pt-8">
      <div class="col-sm-8">
        <div id="main">
          ...
          <p>Bryan Goicochea</p>
          <p>
            <ion-icon name="mail"></ion-icon>man_on_fire_88@hotmail.com
          </p>
          <p>
            <ion-icon name="call"></ion-icon>941713130
          </p>
          <h5 style="color: gray;">REGLAS</h5>
          <p><?php echo $reglas; ?></p>

          <div id="basicMap"></div>
          <h5 style="color: gray;">PREMIOS</h5>
          <p>
            <h6 class="line-bottom" style="color: gray;">1째 PLACE</h6>
            <?php echo $premio1; ?>
            <h6 class="line-bottom" style="color: gray;">2째 PLACE</h6 class="line-botton">
            <?php echo $premio2; ?>

            <h6 class="line-bottom" style="color: gray;">3째 PLACE</h6 class="line-botton">
            <?php echo $premio3; ?>
